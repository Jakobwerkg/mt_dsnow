...
def single_station_run():
    ...
    data_wfj = pd.read_csv("/Users/jakobwerkgarner/code/mt_dsnow/calibration/calibration_data/output/HS_SWE_by_station/Innervillgraten_hs_swe_obs.csv", delimiter=',')  # Adjust delimiter if needed
