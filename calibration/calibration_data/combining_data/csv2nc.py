...
# Project root, located through the .projectroot marker file so that the
# repository works from any checkout location.
...
if __name__ == "__main__":
    ...
    out_dir = ROOT / "calibration/calibration_data/output"

    ds = load_stations_to_nc(
        input_dir=out_dir / "HS_SWE_by_station",
        output_nc=out_dir / "merged_nc_files/HS_SWE_dataset.nc",
    )   